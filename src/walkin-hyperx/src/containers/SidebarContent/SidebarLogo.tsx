			...
			<div className="HyperX-Logo">
				<div className="gx-layout-sider-header">
					...
					{/* <Link to="/" className="gx-pointer">
						<img alt="fgd" src={require("walkin-components/src/assets/images/walkin_logo_mini.png")} style={{ maxWidth: 35 }} />
					</Link> */}
					...
					<Link to={CAMPAIGN_MANAGEMENT} className="gx-site-logo">
						{navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR &&
							width >= TAB_SIZE ?
							<img src={require("walkin-components/src/assets/images/w-logo.png")}
							/> : themeType === THEME_TYPE_LITE ?
								<img src={require("walkin-components/src/assets/images/logo-white.png")}
								/> :
								<img src={require("walkin-components/src/assets/images/hyperx_black1.png")}
