    ...
    popupContent = () => (
      <div>
        <Select
          ...
          optionFilterProp="children" //defaultOpen
        ...
        >
          {this.props.attributeData &&
            this.props.attributeData.map(a => (
          ...
          <Item label="SMS tag" {...formItemLayout}>
            {getFieldDecorator("smsTag", {
              ...
              <Input
                name="smsTag"
                onChange={(e: any) => {
                  this.props.formValues.smsTag = e.target.value;
                }}
              />
            )}
          </Item>
          <Item label="SMS body" {...formItemLayout}>
            {getFieldDecorator("smsBody", {
              ...
              <TextArea
                ...
                name="smsBody"
                onChange={(e: any) => {
                  this.props.formValues.smsBody = e.target.value;
