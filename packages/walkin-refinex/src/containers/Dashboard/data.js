...
export const increamentData = [
  ...
  { name: 'Page A', customer: 0 },
  // { name: 'Page B', customer: 50 },
  // { name: 'Page B', customer: 35 },
  // { name: 'Page C', customer: 70 },
  // { name: 'Page D', customer: 40 },
  ...
  "data": {
    "analytics": [
      ...
      // },
      {
        ...
        "response": [
          {
            "Category": "Ambience or Store Hygiene",
            "number_of_complains": 33
          },
          {
            "Category": "App related issues",
            "number_of_complains": 11
          },
          {
            "Category": "Food or Drink Quality",
            "number_of_complains": 110
          },
          {
            "Category": "Payment/Billing/Offers",
            "number_of_complains": 48
          },
          {
            "Category": "Service/Staff",
            "number_of_complains": 69
          },
          {
            "Category": "Ambience or Store Hygiene",
            "number_of_complains": 33
