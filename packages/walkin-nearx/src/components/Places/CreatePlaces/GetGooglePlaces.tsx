          ...
          {formData.places1.length ? <div>
            ...
            <Row>
              ...
              <div style={{ width: '100%', margin: "10px 40px -15px" }}>
                <p onClick={this.props.selAll} className="gx-text-primary gx-pointer" style={{ float: "right", fontSize: 16 }} > {formData.selectAll ? 'Remove All' : 'Select All'} </p>
              </div>
            </Row>
