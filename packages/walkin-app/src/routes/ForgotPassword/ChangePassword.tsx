                    ...
                    <div className="gx-app-login-main-content">
                        <div className="gx-app-logo-content">
                            ...
                            <div className="gx-app-logo">
                                <img alt="example" src={require("@walkinsole/walkin-components/src/assets/images/walkin_logo_white.png")} style={{ width: 100 }}
                                />
                            </div>
                        </div>
                                        ...
                                        onSubmit={async e => {
                                            ...
                                            this.props.form.validateFields(async (err, values) => {
                                                if (!err) {
                                                    ...
                                                    const { password, conformPassword, remember } = values;
                                    ...
                                    >
                                        ...
                                        <Form.Item hasFeedback>
                                            {getFieldDecorator("conform", {
                                                ...
                                                onBlur={this.handleConfirmBlur} placeholder="Conform Password" />
                                            )}
                                        </Form.Item>

                                        <Form.Item>
                                            <Button type="primary" htmlType="submit" loading={loading} className="login-form-button" style={{ marginTop: 10 }}>
                                                Submit
                                                </Button>
                                        </Form.Item>
                                    </Form>
