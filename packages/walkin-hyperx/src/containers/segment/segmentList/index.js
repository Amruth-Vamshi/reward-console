...
import { allSegments } from '../../../query/audience';
	...
	onSegmentSearch = e => {
		...
		if (e.target.value !== '') {
			...
			newList = currentList.filter(item => {
				...
				const lc = item.segmentName.toLowerCase();
		...
		const columns = [
			{
				...
				key: 'segmentName',
				sorter: (a, b) => (a.segmentName !== b.segmentName ? (a.segmentName < b.segmentName ? -1 : 1) : 0),
			...
			},
			{
				...
				sortOrder: sortedInfo.columnKey === 'audienceSize' && sortedInfo.order,
			},
			{
				title: 'Created On',
				dataIndex: 'createdOn',
