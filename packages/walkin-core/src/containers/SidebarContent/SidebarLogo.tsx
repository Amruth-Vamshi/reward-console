      ...
      <div className="HyperX-Logo">
        <div className="gx-layout-sider-header">
          {width < TAB_SIZE_MAX && width > TAB_SIZE ?
            <Link to={`/core/catalogue/home`} className="gx-pointer">
          ...
          <Link to={`/core/catalogue/home`} className="gx-site-logo">
            {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR &&
              width >= TAB_SIZE ?
              <img alt="" src={require("@walkinsole/walkin-components/src/assets/images/w-logo.png")} /> :
              themeType === THEME_TYPE_LITE ?
                <img alt="" src={require("@walkinsole/walkin-components/src/assets/images/logo-white.png")} /> :
                <img style={{ width: 125 }} alt=""
                  src={require("@walkinsole/walkin-components/src/assets/images/walkin_logo_whitebg.jpg")}
                />
            }
          </Link>
        </div>
